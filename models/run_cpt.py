...
class DataTrainingArguments:
    ...
    cpt: bool = field(
        default=True,
        metadata={
            "help": "Whether to use the denoising pre-training objective instead of sequence transduction fine-tuning" 
        },
    )
...
def main():
    ...
    # uncommenting this will print more specific GPU/CUDA debug info for distributed training
